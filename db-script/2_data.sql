...
(v_name, v_description, c_state, t_create_date, i_create_id, t_update_date, i_update_id, b_deleted)
values
('3track.org', '3track', 'A', '2021-01-01 00:00:00', 0, '2021-01-01 00:00:00', 0, false );

insert into ad_user
(v_name, v_password, c_state, i_person_id, t_create_date, i_create_id, t_update_date, i_update_id, b_deleted, i_organization_id)
values
('admin', 'admin123', 'A', 0, '2021-01-01 00:00:00', 0, '2021-01-01 00:00:00', 0, false, 1 );
